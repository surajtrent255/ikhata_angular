...
$(function () {
  $("#nepali-datepicker").live("mouseover", (event) => {
    if (event) {
      var mainInput = document.getElementById("nepali-datepicker");
      var adElement = document.getElementById("AdDate");
      mainInput.nepaliDatePicker({
        onChange: function (event) {
          mainInput.setAttribute("value", event.bs);

          if (event.ad) {
            adElement.style.display = "block";
            adElement.value = event.ad;
          }
        },
      });
    }
  ...
  $("#nepali-datepicker").live("click", (event) => {
    if (event) {
      var mainInput = document.getElementById("nepali-datepicker");
      var adElement = document.getElementById("AdDate");
      mainInput.nepaliDatePicker({
  ...
  $("#nepali-datepicker1").live("mouseover", (event) => {
    if (event) {
  ...
  $("#nepali-datepicker1").live("click", (event) => {
    if (event) {
      var mainInput = document.getElementById("nepali-datepicker1");
  ...
  $("#nepali-datepicker2").live("mouseover", (event) => {
    if (event) {
  ...
  $("#nepali-datepicker2").live("click", (event) => {
    if (event) {
      var mainInput = document.getElementById("nepali-datepicker2");
  ...
  $("#nepali-datepicker3").live("mouseover", (event) => {
    if (event) {
      var mainInput = document.getElementById("nepali-datepicker3");
  ...
  $("#nepali-datepicker3").live("click", (event) => {
    if (event) {
      var mainInput = document.getElementById("nepali-datepicker3");
...
function countRow() {
  ...
  setTimeout(function () {
    $("#nepali-datepicker-input" + rowCount).on("mouseover", function (event) {
      if (event) {
        var mainInput = document.getElementById(
          "nepali-datepicker-input" + rowCount
        );
    ...
    $("#nepali-datepicker-input" + rowCount).on("click", function (event) {
      if (event) {
        var mainInput = document.getElementById(
          "nepali-datepicker-input" + rowCount
        );
